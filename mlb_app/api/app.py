...
from mlb_app.api.routes import actionnetwork_health, admin, data_health, edge_board, game_odds, health, market_registry, ml_features, ml_labels, ml_models, model_cards, observability, picks, playerboard, predictions, prop_detail, research_report, runtime_status, status, workflow
...
def create_app(
    *,
    ...
    app.include_router(ml_labels.router)
    app.include_router(ml_models.router)
    app.include_router(actionnetwork_health.router)
    app.include_router(data_health.router)
    app.include_router(workflow.router)
    app.include_router(edge_board.router)
    app.include_router(market_registry.router)
